...
describe('GBA Hardware Test Category: 10 SIO register R/W tests', () => {
  let gba: GBA;
  let cart: Uint8Array;
  ...
  it('10 SIO register R/W tests', () => {
    gba.reset();
    gba.directBoot();

    gba.cpu.r[0] = 0x8042fe8;
    gba.cpu.r[1] = 0x03007b08;
    gba.cpu.r[14] = 0x08000100;
    gba.cpu.cpsr = (gba.cpu.cpsr & ~0x20) | ((0x8007e59 & 1) ? 0x20 : 0);
    gba.cpu.r[15] = 0x8007e59 & ~1;
