...
describe('GBA Hardware Test Category: 03 Timer count-up tests', () => {
  let gba: GBA;
  let cart: Uint8Array;
  ...
  it('03 Timer count-up tests', () => {
    ...
    if (failures.length > 0) {
      console.log(`\n--- FAILED SUB-TEST DIAGNOSTICS FOR 03 Timer count-up tests (${failures.length} failures) ---`);
      console.log(failures.join('\n'));
      console.log("--------------------------------------------------------------------------\n");
    }

    console.log("\n==========================================================================");
    console.log(" CATEGORY: 03 Timer count-up tests");
    console.log("==========================================================================");
    ...
    expect(passed).toBeGreaterThanOrEqual(924);
  }, 120000);
});
